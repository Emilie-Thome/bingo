...
def handle_args(args: list[str]) -> tuple[str, int, str]:
    ...
    # do we print help?
    if args[0] == "-h" or args[0] == "--h" or args[0] == "-H" \
       or args[0] == "--H" or args[0] == "-help" or args[0] == "--help":
        print_help()
        sys.exit()
    # correct number of arguments?
    if len(args) != 3:
        sys.exit("input, number of cards, and output paths must be provided, use '-h' for help")
